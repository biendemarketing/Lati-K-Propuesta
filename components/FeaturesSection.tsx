...
const Feature = ({ icon, title, description, imageUrl, reverse = false }: FeatureProps) => (
  ...
  >
    ...
    <motion.div 
      className="w-full md:w-1/2 aspect-video rounded-lg shadow-2xl shadow-[var(--color-primary)]/20 overflow-hidden" 
...
const FeaturesSection = () => {
  ...
  return (
    ...
    >
      <motion.h2
        className="text-4xl md:text-5xl font-bold text-center mb-16 text-[var(--color-primary)]"
